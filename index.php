...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo bloginfo('template_directory'); ?>/IMG/small-logo-01.png" />
	<link href="<?php echo bloginfo('template_directory'); ?>/style.css" rel="stylesheet">
    <link href="<?php echo bloginfo('template_directory'); ?>/CSS/spore-font.css" rel="stylesheet" />
    <link href="<?php echo bloginfo('template_directory'); ?>/CSS/animate.css" rel="stylesheet" />
    <link href="<?php echo bloginfo('template_directory'); ?>/CSS/spore-animate.css" rel="stylesheet" />
...
<div id="A1-main">
	...
	<a href="#"><div id="logo" class="shadow object" ><img src="<?php echo bloginfo('template_directory'); ?>/IMG/logotop.svg" width="169" height="45"/></div></a>
	</div>
...
<div id="wrapper-A3" class="object">
    	...
    	<div id="A3-left">
            ...
            <div id="wrapper-post2" class="text-part-A5">
            	<a href="spore-post2.html"><div id="A3-left-image-2"><img src="<?php echo bloginfo('template_directory'); ?>/IMG/image1-01.jpg"  alt="post an image with animation" title="post an image with animation" class="grow"/></div></a>
             ...
             <div id="wrapper-post3" class="text-part-A5">
            	<a href="spore-post3.html"><div id="A3-left-image-3"><img src="<?php echo bloginfo('template_directory'); ?>/IMG/image6-01.jpg"  alt="Auto-resized image" title="Auto-resized image" class="grow"/></div></a>
    	...
    	<div id="A3-middle">
            ...
            <div id="wrapper-post4" class="text-part-A5">
            	<a href="spore-post4.html"><div id="A3-middle-image-4"><img src="<?php echo bloginfo('template_directory'); ?>/IMG/image3-01.jpg"  alt="Another post" title="Another post" class="grow"/></div></a>
            ...
            <div id="wrapper-post5" class="text-part-A5">
            	<a href="spore-post5.html"><div id="A3-middle-image-5"><img src="<?php echo bloginfo('template_directory'); ?>/IMG/image4-01.jpg"  alt="Another post" title="Another post" class="grayscale" /></div></a>
        ...
        <div id="A3-right">
            ...
            <div id="wrapper-post8" class="text-part-A5">
            	<a href="spore-post8.html"><div id="A3-right-image-8"><img src="<?php echo bloginfo('template_directory'); ?>/IMG/image5-01.jpg"  alt="Post with transition image" title="Post with transition image" class="grow" /></div></a>
            ...
            <div id="wrapper-post9" class="text-part-A5">
            	<a href="spore-post9.html"><div id="A3-right-image-9"><img src="<?php echo bloginfo('template_directory'); ?>/IMG/image2-01.jpg"  alt="Another post" title="Another post" class="grow"/></div></a>
